...
public class DefaultMovieService : IMovieService
{
    ...
    public async Task<Result<PagedResult<Movie>>> ReadMovies(int page, int size)
    {
        ...
        var result = pagedResult == null ? new Result<PagedResult<Movie>>(new Exception($"Could not read movies from page {page} and size {size}."),
        (int)HttpStatusCode.NotFound) : new Result<PagedResult<Movie>>(pagedResult, (int)HttpStatusCode.OK);
    ...
    public async Task<Result<Movie>> CreateMovie(Movie newMovie)
    {
        ...
        var result = movie == null ? new Result<Movie>(new Exception($"Could not create movie {newMovie}."),
        (int)HttpStatusCode.NotFound) : new Result<Movie>(movie, (int)HttpStatusCode.Created);
    ...
    public async Task<Result<Movie>> ReadMovie(int id)
    {
        ...
        var result = movie == null ? new Result<Movie>(new Exception($"Could not read movie with id {id}."),
        (int)HttpStatusCode.NotFound) : new Result<Movie>(movie, (int)HttpStatusCode.OK);
    ...
    public async Task<Result<Movie>> UpdateMovie(int id, Movie newData)
    {
        ...
        var result = movie == null ? new Result<Movie>(new Exception($"Could not update movie {newData} with id {id}."),
        (int)HttpStatusCode.NotFound) : new Result<Movie>(movie, (int)HttpStatusCode.OK);
    ...
    public async Task<Result<Movie>> DeleteMovie(int id)
    {
        ...
        var result = movie == null ? new Result<Movie>(new Exception($"Could not delete movie with id {id}."),
        (int)HttpStatusCode.NotFound) : new Result<Movie>(movie, (int)HttpStatusCode.OK);
